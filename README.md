...
Provide configurable cookie consent plugin for LMC products. The package contains predefined LMC settings,
translations and UI based on [Spirit Design System].
...
| `companyNames`           | array                               | `['LMC']`                                                   | Array of strings with company names. Adjust only when the consent needs to be given to multiple companies. Value "LMC" is replaced with translated legal name. [See example][examples-configuration].    |
