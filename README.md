...
window.addEventListener('DOMContentLoaded', function () {
  initAlmaCareerCookieConsentManager('demo.example'); // use the name of your service, like jobs.cz, seduo.pl etc.
});
</script>
```
...
Once the plugin is loaded, you need to initialize it using `initAlmaCareerCookieConsentManager()` method, optionally providing
...
2. Import the module in your javascript:
    ```js
    import AlmaCareerCookieConsentManager from '@lmc-eu/cookie-consent-manager';

    window.addEventListener('DOMContentLoaded', function () {
      AlmaCareerCookieConsentManager('demo.example'/* , optional plugin configuration */);
    });
    ```
...
3. Include default CSS in your HTML:
   ```html
   <link rel="stylesheet" href="node_modules/@lmc-eu/cookie-consent-manager/AlmaCareerCookieConsentManager.min.css">
   ```
   or in your Sass stylesheet:
   ```scss
   @use "node_modules/@lmc-eu/cookie-consent-manager/AlmaCareerCookieConsentManager.css";
   ```
...
```js
initAlmaCareerCookieConsentManager( // when loaded as a module, these options are passed to `AlmaCareerCookieConsentManager()` instead
...
@use '@lmc-eu/cookie-consent-manager/AlmaCareerCookieConsentManager';
```
...
* Javascript module: http://localhost:3000/dist/AlmaCareerCookieConsentManager.js
* CSS: http://localhost:3000/dist/AlmaCareerCookieConsentManager.css
